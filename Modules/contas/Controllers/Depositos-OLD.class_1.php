...
class Depositos {
    ...
    public function listar($params) {
        try {
            ...
            $tipoDeposito = \Utils\Post::get($params, "tipoDeposito", "T");
        ...
        ?>
            ...
            <tr style="text-decoration: <?php echo $deposito->status == \Utils\Constantes::STATUS_DEPOSITO_CANCELADO ? "line-through;" : "none;" ?>" class="tr-depositos-real"  >
                ...
                <td class='text-center'>
                    <?php echo $deposito->id ?>
                    
                </td>
                
                <td class='text-center'>
                    <?php echo $deposito->dataSolicitacao->formatar(\Utils\Data::FORMATO_PT_BR_TIMESTAMP_LONGO) ?>
                </td>
                ...
                <td class='text-center'>
                    R$ <?php echo number_format($deposito->valorComissao, 2, ",", ".") ?>
                </td>
                <td class='text-center'>
    ...
    public function salvar($params) {
        try {
            ...
            if ($deposito->tipoDeposito == \Utils\Constantes::GERENCIA_NET) {
                $deposito->idContaBancariaEmpresa = 15052774463551;
