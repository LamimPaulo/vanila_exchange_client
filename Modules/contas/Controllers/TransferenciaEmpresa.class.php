    ...
    private function itemListaTransferenciaCurrency(\Models\Modules\Cadastro\ContaCorrenteBtcEmpresa $contaCorrenteBtcEmpresa) { 
        ...
        ?>
            <tr >
                ...
                <td class="text-center"><?php echo number_format($contaCorrenteBtcEmpresa->valor, $contaCorrenteBtcEmpresa->moeda->casasDecimais, ".", "")?></td>
                <td class="text-center">
                    <a tabindex="0" class="btn btn-info btn-popover-currency" role="button" data-controle='<?php echo $contaCorrenteBtcEmpresa->id?>' data-toggle="popover" data-trigger="focus" >Detalhes</a>
                </td>
            </tr>
    ...
    private function itemListaTransferenciaBrl(\Models\Modules\Cadastro\ContaCorrenteReaisEmpresa $contaCorrenteReaisEmpresa) {
        ?>
            ...
            <tr>
                ...
                <td class="text-center">
                    <a tabindex="0" class="btn btn-info btn-popover-brl" role="button" data-controle='<?php echo $contaCorrenteReaisEmpresa->id?>' data-toggle="popover" data-trigger="focus" >Detalhes</a>
                </td>
