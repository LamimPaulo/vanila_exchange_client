 ...
 * @subpackage Acesso
 */
class LogContaCorrenteBtcEmpresa {
     ...
     * @var Integer
     */
    public $idContaCorrenteBtcEmpresa;
    ...
    public function exchangeArray($dados) {
        ...
        $this->idContaCorrenteBtcEmpresa = ((isset($dados ['id_conta_corrente_btc_empresa'])) ? ($dados ['id_conta_corrente_btc_empresa']) : (null));
    }
    
    public function getTable() {
        return "log_conta_corrente_btc_empresa";
    }
    ...
    public function getInstance() {
        return new LogContaCorrenteBtcEmpresa();
    }
