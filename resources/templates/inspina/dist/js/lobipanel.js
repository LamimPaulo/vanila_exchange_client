...
//            css['position'] = 'absolute';
    ...
    LobiPanel.PRIVATE_OPTIONS = {
        ...
        iconClass: 'panel-control-icon gear'
    };
    $.fn.lobiPanel.DEFAULTS = {
        ...
        tooltips: true,
        forAngularJs: false,
        toggleIcon: 'glyphicon glyphicon-cog gear',
        expandAnimation: 100,
    ...
    $('.lobipanel').lobiPanel();
        ...
        //created André 28/08/2019
        //ajust graph resize fullscreen icon file direct book.html
        var sizescreen = $(window).width();



        if(sizescreen <=740 )
           $(".resizeIcon").removeClass("hidden");
       //end created
