...
(function($) {
    $.reject = function(options) {
        var opts = $.extend(true,{
            ...
            header: 'Você sabia que seu navegador está desatualizado?',
            // Paragraph 1
            paragraph1: 'O seu navegador está desatualizado, e não é compatível com nosso '+
            'sistema. Uma lista com os melhores navegadores pode ser  '+
            'encontrada abaixo.',
            // Paragraph 2
            paragraph2: 'Apenas clique em um dos ícones para ir para a página de download',
            close: true, // Allow closing of window
            // Message displayed below closing link
            closeMessage: '',
            closeLink: 'Fechar a janela', // Text for closing link
            closeURL: '#', // Close URL
            ...
            imagePath: './resources/images/browsers/', // Path where images are located
