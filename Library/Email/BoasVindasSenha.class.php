...
class BoasVindasSenha {
    ...
    public static function send($cliente) {
        ...
        ob_start();
        \Utils\Layout::append("emails/bemvindo_senha", $params);
        ...
        $mail = new \Utils\Mail($brand->nome, $idioma->getText("contaAtivadaAss") , $conteudo, $listaEnvio);
        $mail->send();
