        ...
        //    }
            ...
            try {
                if ($emailBoasVindas) {
                    ...
                    try {
                        if ($cliente->idClienteConvite > 0) { 
                            $clienteConvidadoRn = new ClienteConvidadoRn();
                            $clienteConvidadoRn->marcarCadastrado(new Cliente(Array("id" => $cliente->idClienteConvite)), $cliente->email);
                        } else if ($cliente->idReferencia > 0) {
                            $clienteConvidadoRn = new ClienteConvidadoRn();
                            $clienteConvidadoRn->marcarCadastrado(new Cliente(Array("id" => $cliente->idReferencia)), $cliente->email);
                        }
                    } catch (\Exception $ex) {
