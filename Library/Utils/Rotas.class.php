...
public static $rotas = Array(
        ...
        "testeGerarBoleto"                         => Array("url" => "api/procedimentosPerigosos/testeGerarBoleto" ,              "modulo" => "api",                    "rotina" => "coins" ),
...
//     
        ...
        "garantia"                                          => Array("url" => "staking/staking/index_garantia" ,                                       "modulo" => "staking",                            "rotina" => "mercado" ),
